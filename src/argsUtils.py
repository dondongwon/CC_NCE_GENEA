...
def get_args_perm():
  ...
  ## Dataset Parameters
  parser.add_argument('-path2data', nargs='+', type=str, default=['/projects/dataset_processed//groot/data'],
                      help='path to data')
  parser.add_argument('-path2outdata', nargs='+', type=str, default=['/projects/dataset_processed/groot/data'],
  ...
  parser.add_argument('-time', nargs='+', type=float, default=[4.3],
  ...
  parser.add_argument('-DTW', nargs='+', type=int, default=[1],
                      help='Use DTW in Contrastive Settings')  
